...
True Type Font: Small Bold Pixel-7 version 1.0


EULA
-==-
The font Small Bold Pixel-7 is freeware for home using only.


DESCRIPTION
-=========-
Original bold pixel font 6*8 pixels.

Files in small_bold_pixel-7.zip:
       	readme.txt     				this file;
        small_bold_pixel-7.ttf    		regular font;
	small_bold_pixel-7_screen.png		preview image.
